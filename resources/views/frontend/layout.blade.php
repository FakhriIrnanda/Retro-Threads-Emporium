...
<html class="no-js" lang="en">
    ...
    <body>
                ...
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        <div class="logo-2 furniture-logo ptb-30">
                            <a href="/">
                                <img src="{{ asset('themes/ezone/assets/img/logo/2_fix.png') }}" alt="">
                            </a>
                        </div>
                ...
                <div class="services-wrapper">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            <h4>Bisa Kirim ke Seluruh Indonesia</h4>
                            <p>Kami Siap Kirim Pesanan, dihari yang sama. </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>24/7 Support</h4>
                            <p>Kami selalu tersedia, untuk anda. </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            ...
                            <p>Nikmati kemudahan pembayaran tanpa khawatir dengan kami! </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="footer-area">
            <div id="footer" class="footer-top-area pt-70 pb-35 wrapper-padding-5">
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            <a href="#"><img src="{{ asset('themes/ezone/assets/img/logo/2_fix.png') }}" alt=""></a>
                            <div class="footer-about-2">
                                <p>Retro Threads Emporium  <br>memberikan pengalaman belanja yang unik dan memuaskan, <br> bagi para pecinta mode retro dan vintage</p>
                            </div>
                        </div>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>JL.Tempua I No.3 <br>Padang, Sumatera Barat</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>+6285959645653 <br>+6281908965063</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> Retro_Threads@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © Retro Threads Emporium </a> 2024 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
