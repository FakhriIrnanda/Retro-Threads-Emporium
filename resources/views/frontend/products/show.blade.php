...
@section('content')
	<div class="breadcrumb-area pt-205 pb-210" style="background-image: url({{ asset('themes/ezone/assets/img/bg/bg_detailproduk.png') }})">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-5 col-12">
					<div class="product-details-content">
						...
						<div class="product-details-cati-tag mtb-10"></div>
